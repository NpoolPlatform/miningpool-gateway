...
func (s *Server) AdminCreateFractionWithdrawalRule(ctx context.Context,
	in *npool.AdminCreateFractionWithdrawalRuleRequest) (*npool.AdminCreateFractionWithdrawalRuleResponse, error) {
